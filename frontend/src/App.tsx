    ...
    if (this.state.hasError) {
      return (
        <div className="p-8 bg-[#121214] border border-red-500/20 rounded-2xl text-center space-y-4 max-w-xl mx-auto my-12">
          ...
          <p className="text-sm text-gray-400">{typeof this.state.error?.message === 'string' ? this.state.error.message : String(this.state.error || 'Something went wrong rendering this section.')}</p>
          <button
